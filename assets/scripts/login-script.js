...
/*Mambuat variabel untuk setiap elemen view.*/
const loginFormElement = document.querySelector('#loginForm');
const inputEmailElement = document.querySelector('#inputEmail');
const inputPasswordElement = document.querySelector('#inputPassword');

/*Membuat variabel untuk menyimpan informasi email dan paswoard.*/
...
loginFormElement.addEventListener('submit', function(event) {
    ...
    /*Mendapatkan nilai dari masing-masing input (email dan passwoard) ketika tombol ditekan.*/
    ...
    /*Memastikan bahwa nilai email dan passwoard sesuai dengan nilai yang tersimpan.*/
